<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewList.aspx.cs" Inherits="Locaris.LJKDev_Asp.NetStudy.WebApp._2020_06_01.NewList" %>
...
<body class="body_column">
	<div id="wrap_column">
       <!----------------------------------begin header_column---------------------------------->
       <div id="header_column" class="header_news"><!-- #BeginLibraryItem "/Library/header.lbi" --><h1 class="logo_column"><a href="WebDemos/index.html"><img src="WebDemos/images/logo.png" width="179" height="55" alt="北京华科世佳软件开发有限公司" /></a></h1>
        ...
        <dl class="menu_prd">
      	...
      	<div id="content_column">
            ...
            <div class="cont">
                ...
                <div class="pages"><a href="NewList.aspx?pageIndex=1">首页</a>  |  <a href="NewList.aspx?pageIndex=<%=PageIndex -1 <1?1:PageIndex -1%>">前页</a>  |  
                    <a href="NewList.aspx?pageIndex=<%=PageIndex +1>PageCount?PageIndex:PageIndex +1 %>">后页</a> | <a href="NewList.aspx?pageIndex=<%=PageCount %>">尾页</a>         页次：<%=PageIndex %>/<%=PageCount %>页 </div>
                <hr/>
                <div>
